class Ferret # Class should be capitalized
    
    def set_name=(ferret_name) # No space before and after = sign
        @name = ferret_name
    end
...
class Chinchilla # Make sure variable name is spelled right each time
    
    def set_name=(chinchilla_name)
        @name = chinchilla_name
    end
    
    def get_name # This class method was forgotten
        return @name
    end
...
class Parrot
    ...
    def set_name=(parrot_name)
        @name = parrot_name # Argument has to match (parrot_name)
    end
...
print "#{ferret_name} says #{my_ferret.squeal}, 
